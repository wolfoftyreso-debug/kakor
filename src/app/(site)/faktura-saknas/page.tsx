  ...
  return (
    <div className="container-narrow" style={{ padding: "64px 24px", textAlign: "center" }}>
      ...
      <p style={{ maxWidth: "48ch", margin: "12px auto 0", fontSize: 15.5, lineHeight: 1.65, color: "var(--text-2)" }}>
        Länken är ofullständig eller hör till en faktura som inte finns. Fakturan bifogades som
        PDF i fakturamejlet till er faktura-e-post, och orderbekräftelsen har en nedladdningslänk.
        Behöver ni en ny kopia: svara på något av de mejlen med fakturanumret så skickar vi den.
      </p>
