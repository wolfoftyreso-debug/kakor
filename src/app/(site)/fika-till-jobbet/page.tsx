...
const DESCRIPTION =
  "Guide till kontorsfika och kakor till kontoret: hur många småkakor per person, fredagsfika och hur ni beställer med leverans mot faktura.";
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Ett fat med klassiska småkakor räcker långt: det kräver ingen servering, går att dela ut på flera avdelningar och passar både förmiddagskaffet och eftermiddagen. Välj leveransdagen närmast före så finns det på plats när ni samlas.",
  },
  {
    ...
    <>
      ...
      <article className="container-narrow prose" style={{ padding: "16px 24px 80px" }}>
        ...
        <table style={{ marginTop: 18 }}>
          <caption className="rule-label" style={{ textAlign: "left", captionSide: "top" }}>Kakor att räkna med</caption>
          <thead>
            <tr>
              <th scope="col">Antal personer</th>
              <th scope="col" className="num">Lätt fika (3 st)</th>
              <th scope="col" className="num">Rejäl fika (5 st)</th>
            </tr>
          </thead>
          <tbody>
            {GROUPS.map((n) => (
              <tr key={n}>
                <th scope="row" style={{ fontWeight: 700, textAlign: "left" }}>{n} personer</th>
        ...
        <h2>Kontorsfika – kakor till kontoret</h2>
        <p>
          Kontorsfika är det som står framme vid kaffemaskinen varje dag: kaffe, te och något att
          bita i. Kaffet på kontoret är oftast löst. Det som saknas är kakor till kontoret.
